...
public class Home implements ActionListener, IHome{
	...
	private JMenuItem faysal, vuban, emon, yeamin,tawhid, tayeebi, profile, logout, changeBGColor;
	...
	public Home(String user)
	{
		...
		tayeebi = new JMenuItem ("Tayeebi");
		tayeebi.addActionListener(this);
		tayeebi.setCursor(new Cursor(Cursor.HAND_CURSOR));
	...
	public void actionPerformed(ActionEvent e) {
		...
		else if(e.getSource()==tayeebi)
		{
			new TayeebiProfile(f);
			frame.setVisible(false);
		}
