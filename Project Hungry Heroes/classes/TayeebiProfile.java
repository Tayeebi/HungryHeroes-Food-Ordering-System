...
public class TayeebiProfile implements ActionListener, ITayeebiProfile
{
	...
	public TayeebiProfile(String user)
	{
		f=user;
		frame = new JFrame("Tayeebi");
		
		ImageIcon framelogo = new ImageIcon("icons/framelogo.jpg");
		Image image1 = new ImageIcon("icons/tayeebi.png").getImage().getScaledInstance(537, 560, Image.SCALE_SMOOTH);
		ImageIcon tayeebi = new ImageIcon(image1);
